...
const sceneConfig = getSceneConfig(156);
const REFERENCE_DIR = path.resolve(__dirname, "../../../../reference/lite/scene156-manual-cross-fade");
const GOLDEN_REF = path.join(REFERENCE_DIR, "babylon-ref-golden.png");
const SEEK_TIME = 1.25;

test.skip(!!sceneConfig.skipParity, "Scene 156 skipped via skipParity in scene-config.json");

test("Scene 156 — manual cross-fade animation matches Babylon.js reference", async ({ page }, testInfo) => {
