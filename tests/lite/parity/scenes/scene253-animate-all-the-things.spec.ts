...
const sceneConfig = getSceneConfig(253);
const REFERENCE_DIR = path.resolve(__dirname, "../../../../reference/lite/scene253-animate-all-the-things");
const GOLDEN_REF = path.join(REFERENCE_DIR, "babylon-ref-golden.png");

test.skip(!!sceneConfig.skipParity, "Scene 253 skipped via skipParity in scene-config.json");

test("Scene 253 — AnimateAllTheThings matches Babylon.js reference", async ({ page }, testInfo) => {
