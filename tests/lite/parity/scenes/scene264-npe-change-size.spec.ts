...
const REFERENCE_DIR = path.resolve(__dirname, "../../../../reference/lite/scene264-npe-change-size");
const GOLDEN_REF = path.join(REFERENCE_DIR, "babylon-ref-golden.png");

test.skip(!!sceneConfig.skipParity, "Scene 264 skipped via skipParity in scene-config.json");

test("Scene 264 — NPE particle system (Change - Size) matches Babylon.js reference", async ({ page }, testInfo) => {
