/**
 * Scene 171 — Navigation Crowd Path Parity Test
 *
...
const sceneConfig = getSceneConfig(171);
const REFERENCE_DIR = path.resolve(__dirname, "../../../../reference/lite/scene171-navigation-crowd-path");
const GOLDEN_REF = path.join(REFERENCE_DIR, "babylon-ref-golden.png");

test.skip(!!sceneConfig.skipParity, "Scene 171 skipped via skipParity in scene-config.json");

test("Scene 171 — Navigation Crowd Path matches Babylon.js reference", async ({ page }, testInfo) => {
