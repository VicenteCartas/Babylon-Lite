/**
 * Scene 174 — Navigation Off-Mesh Connections Parity Test
 *
...
const sceneConfig = getSceneConfig(174);
const REFERENCE_DIR = path.resolve(__dirname, "../../../../reference/lite/scene174-navigation-offmesh");
const GOLDEN_REF = path.join(REFERENCE_DIR, "babylon-ref-golden.png");

test.skip(!!sceneConfig.skipParity, "Scene 174 skipped via skipParity in scene-config.json");

test("Scene 174 — Navigation Off-Mesh Connections matches Babylon.js reference", async ({ page }, testInfo) => {
