...
const sceneConfig = getSceneConfig(79);
const REFERENCE_DIR = path.resolve(__dirname, "../../../../reference/lite/scene79-nme-modes");
const GOLDEN_REF = path.join(REFERENCE_DIR, "babylon-ref-golden.png");

test.skip(!!sceneConfig.skipParity, "Scene 79 skipped via skipParity in scene-config.json");
