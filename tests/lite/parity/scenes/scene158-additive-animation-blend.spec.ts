...
const sceneConfig = getSceneConfig(158);
const REFERENCE_DIR = path.resolve(__dirname, "../../../../reference/lite/scene158-additive-animation-blend");
const GOLDEN_REF = path.join(REFERENCE_DIR, "babylon-ref-golden.png");
const SEEK_TIME = 1.2;

test.skip(!!sceneConfig.skipParity, "Scene 158 skipped via skipParity in scene-config.json");

test("Scene 158 — additive animation blend matches Babylon.js reference", async ({ page }, testInfo) => {
