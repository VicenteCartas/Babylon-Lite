/**
 * Scene 32 — Unlit glTF Parity Test
 *
...
const REFERENCE_DIR = path.resolve(__dirname, "../../../../reference/lite/scene32-unlit");
const GOLDEN_REF = path.join(REFERENCE_DIR, "babylon-ref-golden.png");

test.skip(!!sceneConfig.skipParity, "Scene 32 skipped via skipParity in scene-config.json");

test("Scene 32 — Unlit glTF matches Babylon.js reference", async ({ page }, testInfo) => {
