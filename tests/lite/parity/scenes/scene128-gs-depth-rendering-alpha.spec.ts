...
const sceneConfig = getSceneConfig(128);
const REFERENCE_DIR = path.resolve(__dirname, "../../../../reference/lite/scene128-gs-depth-rendering-alpha");
const GOLDEN_REF = path.join(REFERENCE_DIR, "babylon-ref-golden.png");

test.skip(!!sceneConfig.skipParity, "Scene 128 skipped via skipParity in scene-config.json");

test("Scene 128 — GS alpha-blended depth rendering matches Babylon.js reference", async ({ page }, testInfo) => {
