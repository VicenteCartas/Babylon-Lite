...
const sceneConfig = getSceneConfig(125);
const REFERENCE_DIR = path.resolve(__dirname, "../../../../reference/lite/scene125-gs-bake-transform");
const GOLDEN_REF = path.join(REFERENCE_DIR, "babylon-ref-golden.png");

test.skip(!!sceneConfig.skipParity, "Scene 125 skipped via skipParity in scene-config.json");

test("Scene 125 — GS bakeCurrentTransformIntoVertices matches Babylon.js reference", async ({ page }, testInfo) => {
