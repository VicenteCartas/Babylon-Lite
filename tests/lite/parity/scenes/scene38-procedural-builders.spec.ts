/**
 * Scene 38 — Procedural Builders Parity Test
 *
 * Renders cylinder, cone, plane, disc, ring, polyhedron, ribbon, tube, and
...
const REFERENCE_DIR = path.resolve(__dirname, "../../../../reference/lite/scene38-procedural-builders");
const GOLDEN_REF = path.join(REFERENCE_DIR, "babylon-ref-golden.png");

test.skip(!!sceneConfig.skipParity, "Scene 38 skipped via skipParity in scene-config.json");

test("Scene 38 — Procedural Builders matches Babylon.js reference", async ({ page }, testInfo) => {
