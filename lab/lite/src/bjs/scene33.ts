...
(async function () {
    ...
    await SceneLoader.AppendAsync("https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Sample-Assets@main/Models/LightsPunctualLamp/glTF-Binary/", "LightsPunctualLamp.glb", scene);
