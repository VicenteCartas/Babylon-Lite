...
(async function () {
    ...
    await SceneLoader.AppendAsync("https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Sample-Assets@main/Models/SheenWoodLeatherSofa/glTF-Binary/", "SheenWoodLeatherSofa.glb", scene);
