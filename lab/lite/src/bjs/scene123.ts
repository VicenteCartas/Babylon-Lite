// Scene 123 — BJS reference for Gaussian Splatting SPZ parity.
// Mirrors playground XSNFXP#12: loads via ImportMeshAsync with
// `spzLibraryUrl: undefined` so the inline JS parser is used (no WASM).
