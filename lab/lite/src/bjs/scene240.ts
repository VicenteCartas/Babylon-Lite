...
(async function () {
    ...
    await SceneLoader.AppendAsync("", "https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Sample-Assets@main/Models/AnimatedTriangle/glTF/AnimatedTriangle.gltf", scene);
    ...
    const camera = new ArcRotateCamera("camera", 1.5707963, 1.5707963, 2.12, new Vector3(-0.5, 0.5, 0), scene);
    camera.fov = 0.8;
    camera.minZ = 2.12 * 0.01;
    camera.maxZ = 2.12 * 1000;
