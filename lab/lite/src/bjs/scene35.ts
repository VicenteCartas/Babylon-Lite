...
(async function () {
    ...
    await SceneLoader.AppendAsync("https://cdn.jsdelivr.net/gh/KhronosGroup/glTF-Sample-Assets@main/Models/SimpleInstancing/glTF-Binary/", "SimpleInstancing.glb", scene);
